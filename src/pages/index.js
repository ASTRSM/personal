  ...
  return (
    <>
      ...
      <main className=' text-primary px-5 md:px-20 overflow-x-hidden'>
        <Hamburger />
        <aside className='fixed left-0 top-0 z-50 m-8 transition-opacity opacity-0 duration-300 hidden lg:block'>
          <ul className='font-inter hover:[&>*]:text-secondary grid place-items-center'>
            <li className='mb-4 font-semibold'>目次</li>
            <li>
              <a href='#profile'>PROFILE</a>
            </li>
            <li className='w-[1px] h-4 border-r-[1px] border-dotted border-primary'></li>
            <li>
        ...
        <Noise />
        <section className='[&_*]:transition-all' id='hero'>
          <div className='[&>*]:z-20 flex flex-col items-center justify-center h-screen'>
            ...
            <h1 className='text-7xl md:text-8xl font-crake font-black lg:text-center'>
              DHAFA DEFRITO RAMA YUDISTIRA
            </h1>
            <nav className='flex flex-row space-x-5 mt-5'>
              <a
                href='#profile'
                className='text-lg md:text-2xl font-inter font-extralight hover:text-secondary'
              >
                PROFILE
              </a>
              <a
        ...
        <section
          id='profile'
          className='h-screen flex justify-center xl:justify-between xl:gap-0 relative items-center xl:items-start 2xl:m-44'
        >
          <div className='flex flex-col max-w-md gap-10 py-10 [&>*]:z-20 md:mr-10'>
            <div className='flex justify-center gap-10 xl:justify-start items-center'>
              <Title
                text={['PRO', <br key='profile'></br>, 'FILE']}
                jp='プロファイル'
              />
              <Image
                src={glowieWave}
            ...
            <p className='text-white text-justify'>
              I&apos;m a fullstack web and mobile developer who mainly uses React
              environment and for Backend, I usually use Express/Laravel and
              Firebase/Supabase. I also have a strong background in UIX and
              design with Figma or Photoshop. I&apos;m currently taking interest
              in DevOps and have been learning tools like Docker, Github
              Actions, and Jenkins to improve my deployment processes.
            </p>
          </div>
          <Image
            src={star}
        ...
        <section
          id='timeline'
          className='flex flex-col md:flex-row justify-between 2xl:m-44 items-center xl:items-start [&>*]:z-20'
        >
          <div className='flex md:flex-col xl:justify-start items-center justify-center gap-10'>
            <Title
              text={['TIME', <br key='timeline'></br>, 'LINE']}
              jp='歴史'
            />
            <Image
              src={circle}
          ...
          <TimelineItem
            ...
            <TimelineItem
              ...
              title='Dicoding Kampus Merdeka'
              work='Front-End & Back-End Web Developer'
            />
            <TimelineItem
              date='2019 - 2023'
        ...
        <section
          id='works'
          className='flex flex-col justify-between 2xl:mx-44 2xl:mt-44 items-center xl:items-start [&>*]:z-20'
        >
        ...
        <section
          id='framework'
          className='flex flex-col justify-between 2xl:mx-44 items-center xl:items-start [&>*]:z-20'
        >
        ...
        <section
          id='contact'
          className='h-screen flex justify-center xl:justify-between xl:gap-0 relative items-center xl:items-start 2xl:mx-44 2xl:mt-44'
        >
            ...
            <div className='flex justify-between w-full relative bg-custom-gradient p-10 border border-primary text-xs sm:text-base'>
              <div className='max-w-md space-y-5 text-white'>
                ...
                <div className='grid grid-cols-2 gap-5 font-notojp font-extralight text-xs sm:text-lg'>
                  <a
                    href='mailto:ddefrito@gmail.com'
                    target='_blank'
                    rel='noreferrer'
                    className='space-y-1 p-1 outline-1 hover:outline hover:outline-primary hover:bg-background transition-all'
                  >
                    <Image
                      src={mail}
                      alt='gmail'
                  ...
                  <a
                    href='https://wa.me/6285959400546'
                    target='_blank'
                    rel='noreferrer'
                    className='space-y-1 p-1 outline-1 hover:outline hover:outline-primary hover:bg-background transition-all'
                  >
        ...
        <section className='2xl:mx-44 relative flex items-center xl:items-start flex-col gap-20'>
          ...
          <div className='flex flex-col md:flex-row text-lg w-full gap-y-10 gap-x-40 xl:gap-x-10 flex-wrap xl:flex-nowrap justify-center xl:justify-between [&>*]:z-20] mb-44'>
            <div className='flex flex-col gap-2'>
              <h2 className='bg-primary font-inter font-extralight text-white text-center'>
                LANGUAGE
              </h2>
              <p className='font-inter font-extralight text-white'>
                Indonesian / <span className='inter-notojp'>母語</span>
              </p>
              <p className='font-inter font-extralight text-white'>
                English / <span className='inter-notojp'>英語</span>
              </p>
              <p className='font-inter font-extralight text-white'>
                Japanese / <span className='inter-notojp'>日本語</span>
              </p>
            </div>
            <div className='flex flex-col gap-2'>
              <h2 className='text-primary font-crake font-extralight border border-primary md:border-none text-center md:text-left'>
                HOBBY
              </h2>
              <p className='font-inter font-extralight text-white'>
                Reading / <span className='inter-notojp'>読書</span>
              </p>
              <p className='font-inter font-extralight text-white'>
                Guitar Jamming / <span className='inter-notojp'>弾き語り</span>
              </p>
              <p className='font-inter font-extralight text-white'>
                Learning Japanese /{' '}
                <span className='inter-notojp'>日本語勉強</span>
              </p>
            </div>
            <div className='flex flex-col gap-2 max-w-2xl'>
              <a
                href='https://www.youtube.com/playlist?list=PL7lkTmqIlvrG1_2RRpLbsqBZ4jQufKudB'
                className='text-primary font-inter font-extralight hover:text-white transition-colors w-fit'
                target='_blank'
                rel='noreferrer'
              >
                MUSIC PLAYLIST /
