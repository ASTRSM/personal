...
export default function Slideshow() {
  const pages = ['Jasmine', 'Yomi', 'Restlater', 'Rasa Group', 'Amari']
  const pagination = {
  ...
  return (
    <div className='w-full'>
      <div className='w-full flex-col justify-center items-center'>
        ...
        >
          <SwiperSlide>
          <Link href='https://www.figma.com/file/eCTHY33eBmNpVHFuNg2gvz/Jaklingko-Mailing-System?node-id=14%3A191&t=O678XFBLla3S5sct-1'>
          ...
          <SwiperSlide>
            <Link href='https://yomi-learn.web.app/'>
          ...
          <SwiperSlide>
            <Link href='https://rest-later.web.app/'>
          ...
          <SwiperSlide>
            <Link href='https://rasa-compro.vercel.app/'>
          ...
          <SwiperSlide>
            <Link href='https://www.figma.com/proto/EN3ZpaDA9gFCYKeMvmFjrg/Amari?node-id=201%3A1309&scaling=scale-down&page-id=80%3A255&starting-point-node-id=157%3A540'>
